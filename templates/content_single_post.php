<div id="<? echo $post['id']; ?>" class="post-wrapper">
	...
	<div class="post-footer">
		<div class="post-message">
			<? echo $post['message'] ? esc_html($post['message']) : esc_html($post['description']);?>
		</div>
			...
			<div class="post-like <? echo $post['likes'] ? '' : 'hide'; ?>">
				<a href="<? echo esc_html($post['permalink_url']); ?>" target="_blank">
					...
					<div class="like-count">
						<? echo $post['likes'] ? esc_html($post['likes']['count']) : ''; ?>
					</div>
				</a>
			</div>
			<div class="post-comment <? echo $post['comments'] ? '' : 'hide'; ?>">
				<a href="<? echo esc_html($post['permalink_url']); ?>" target="_blank">
					...
					<div class="comment-count">
						<? echo $post['comments'] ? esc_html($post['comments']['counts']) : ''; ?>
					</div>
				</a>
			</div>
			<div class="post-share <? echo $post['shares'] ? '' : 'hide'; ?>">
				<a href="<? echo esc_html($post['permalink_url']); ?>" target="_blank">
					...
					<div class="share-count">
						<? echo $post['shares'] ? esc_html($post['shares']['count']) : ''; ?>
					</div>
				</a>
			</div>
			<div class="post-open <? echo $post['permalink_url'] ? '' : 'hide'; ?>">
				<a href="<? echo esc_html($post['permalink_url']); ?>" target="_blank">
